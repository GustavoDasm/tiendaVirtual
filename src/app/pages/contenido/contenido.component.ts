...
export class ContenidoComponent {
  ...
  productos: Producto[] = [
    ...
    },
    {
      ...
      descripcion: 'Razer Blade 15 Advanced, Intel i7, NVIDIA RTX 3070, 16GB RAM',
      precio: 3299,
      precioPromocion: 3099,
...
/*   agregarAlCarrito1(producto: Producto) {
    this.router.navigate(['/carrito', producto.id]); 
    console.log(producto)
  } */

/*     agregarAlCarrito2(id: number){
